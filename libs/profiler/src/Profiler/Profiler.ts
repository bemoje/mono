...
/**
 * A utility class for profiling functions, classes, and modules to measure execution time and other performance metrics.
 *
 * @remarks
 * The Profiler provides various static methods to wrap functions, classes, and modules with profiling functionality.
 * This allows for detailed performance monitoring, including metrics like total execution time, average execution time,
 * minimum and maximum execution times, and call counts.
 *
 * Profiling can be enabled or disabled globally using the `enabled` static property.
 */
