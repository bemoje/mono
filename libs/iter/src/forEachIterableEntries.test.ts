...
describe(forEachIterableEntries.name, () => {
  it('examples', () => {
    expect(() => {
      ...
      forEachIterableEntries(entries, (value, key) => {
        values.push(value)
        keys.push(key)
      })
      ...
      // side effects
      let sum = 0
      forEachIterableEntries(entries, (value) => {
        sum += value
      })
  ...
  it('should work with Map entries', () => {
    ...
    forEachIterableEntries(map, (value, key) => {
