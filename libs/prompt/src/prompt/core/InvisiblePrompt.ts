...
import type { IInvisiblePrompt } from './types'
 ...
 */
export class InvisiblePrompt<T extends string = string> extends AbstractUserPrompt<IInvisiblePrompt<T>, T> {
  /**
   * @param type - The type of prompt
   * @param message - The message to display to the user
   */
  constructor(message: string) {
    super('invisible', message)
  }
